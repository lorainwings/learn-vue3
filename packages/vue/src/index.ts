export * from '@v-next/runtime-dom'

import { baseCompile } from '@v-next/compiler-core'
import * as runtimeDOM from '@v-next/runtime-dom'
import { registerRuntimeCompiler } from '@v-next/runtime-dom'
